function Modal({ year, movie, imdb, setShowModal, onConfirm, showModal }) {
  return (
    <div
      className={
    ...
    >
      <div
        className={
          ...
          ' ' +
          `bg-[#333] rounded-lg sm:translate-y-0 max-w-lg w-full flex flex-col gap-1 divide-y transition-transform duration-300 
               shadow-lg shadow-indigo-900/50 divide-[#6a4ebd] px-4`
        }
      >
